...
def test_produto_atributo_nome(nome):
    try:
        ...
        raise AssertionError(
            'Erro ao inicializar o atributo privado nome na classe Produto')
...
def test_produto_property_nome(nome):
    try:
        ...
        raise AssertionError(
            'Erro no valor da property nome na classe Produto')


@pytest.mark.parametrize('preco', [100, 100.5])
def test_produto_preco_valido(preco):
    try:
        tipo = 'int' if isinstance(
            preco, int) else 'float' if isinstance(preco, float) else ''
        prod = loja.Produto('Jogo online', preco)
    except Exception:
        raise AssertionError(
            'Erro ao criar Produto com preço do tipo {0}'.format(tipo))
...
def test_cria_produto_nome_vazio():
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para Produto criado com nome vazio')
    else:
...
def test_produto_setter_nome_vazio():
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError no setter nome da classe Produto quando o nome é vazio')
    assert hasattr(
        prod, "_Produto__nome"), "A classe Produto não possui o atributo privado nome"
...
def test_cria_produto_preco_invalido(preco):
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError para Produto criado com preço que não é int nem float')
    else:
...
def test_cria_produto_preco_negativo(preco):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para Produto criado com preço negativo')
    else:
...
def test_produto_setter_preco_invalido(preco):
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError no setter do preço quando o novo_preco não é int nem float')
    assert hasattr(
        prod, "_Produto__preco"), "A classe Produto não possui o atributo privado preco"
...
def test_produto_setter_preco_negativo(preco):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError no setter do preço quando o novo_preco é negativo')
    assert hasattr(
        prod, "_Produto__preco"), "A classe Produto não possui o atributo privado preco"
...
def test_produto_metodo_calcular_preco_com_frete(preco):
    ...
    assert prod.calcular_preco_com_frete(
    ) == preco, "O método calcular_preco_com_frete() deve retornar o preço do Produto"
...
def test_cria_produtoFisico(atributo):
    try:
        ...
        mensagens_atributos = {
            '_ProdutoFisico__peso': 'Não criou o atributo privado peso'}
        assert hasattr(prod, atributo), mensagens_atributos[atributo]
...
def test_produtoFisico_heranca():
    try:
        ...
        raise AssertionError('Erro no construtor da classe ProdutoFisico')
    assert isinstance(prod, loja.Produto) and isinstance(
        prod, loja.ProdutoFisico), 'A classe ProdutoFisico deve herdar da classe Produto'
...
def test_produtoFisico_caracteristicas_herdadas():
    try:
        ...
        raise AssertionError('Erro no construtor da classe ProdutoFisico')
    assert ('_Produto__nome' in dict_attrs_obj) and ('_Produto__preco' in dict_attrs_obj) and ('_ProdutoFisico__nome' not in dict_attrs_obj) and (
        '_ProdutoFisico__preco' not in dict_attrs_obj), 'A classe ProdutoFisico não deve possuir os atributos privados nome e preco'
    assert ('nome' not in dict_attrs_classe) and (
        'preco' not in dict_attrs_classe), 'A classe ProdutoFisico deve herdar as properties da classe Produto'
...
def test_cria_produtoFisico_inicializado_corretamente(nome, preco, peso):
    ...
    assert hasattr(
        prod, "_Produto__preco"), "A classe Produto não possui o atributo privado preco"
    assert hasattr(
        prod, "_ProdutoFisico__peso"), "A classe ProdutoFisico não possui o atributo privado peso"
...
def test_produtoFisico_property_peso(peso):
    try:
        ...
        raise AssertionError(
            'Erro no valor da property peso na classe ProdutoFisico')
...
def test_cria_produtoFisico_peso_invalido(peso):
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError para ProdutoFisico criado com peso que não é int')
    else:
...
def test_cria_produtoFisico_peso_nao_positivo(peso):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para ProdutoFisico criado com peso negativo ou igual a zero')
    else:
        raise AssertionError(
            'ProdutoFisico criado com peso negativo ou igual a zero')
...
def test_produtoFisico_setter_peso_invalido(peso):
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError no setter do peso quando o novo_peso não é int')
    assert hasattr(
        prod, "_ProdutoFisico__peso"), "A classe ProdutoFisico não possui o atributo privado peso"
...
def test_produtoFisico_setter_peso_nao_positivo(peso):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError no setter do peso quando o novo_peso é negativo ou igual a zero')
    assert hasattr(
        prod, "_ProdutoFisico__peso"), "A classe ProdutoFisico não possui o atributo privado peso"
...
def test_produtoFisico_metodo_calcular_preco_com_frete(preco, peso, total):
    ...
    assert prod.calcular_preco_com_frete(
    ) == total, "O método calcular_preco_com_frete() não calculou o preço com frete do ProdutoFisico corretamente"
...
def test_produtoFisico_metodo_peso_em_kg(peso, peso_kg):
    try:
        ...
        raise AssertionError('Erro ao instanciar um ProdutoFisico')
    assert prod.peso_em_kg(
    ) == peso_kg, "O método peso_em_kg() não calculou o peso em kg do ProdutoFisico corretamente"
...
def test_produtoEletronico_heranca():
    try:
        ...
        raise AssertionError('Erro no construtor da classe ProdutoEletronico')
    assert isinstance(prod, loja.ProdutoFisico) and isinstance(
        prod, loja.ProdutoEletronico), 'A classe ProdutoEletronico deve herdar da classe ProdutoFisico'
...
def test_produtoEletronico_caracteristicas_herdadas():
    try:
        ...
        raise AssertionError('Erro no construtor da classe ProdutoEletronico')
    assert ('_Produto__nome' in dict_attrs_obj) and ('_Produto__preco' in dict_attrs_obj) and ('_ProdutoFisico__peso' in dict_attrs_obj) and ('_ProdutoEletronico__nome' not in dict_attrs_obj) and (
        '_ProdutoEletronico__preco' not in dict_attrs_obj) and ('_ProdutoEletronico__peso' not in dict_attrs_obj), 'A classe ProdutoEletronico não deve possuir os atributos privados nome, preco e peso'
    assert ('nome' not in dict_attrs_classe) and ('preco' not in dict_attrs_classe) and (
        'peso' not in dict_attrs_classe), 'A classe ProdutoEletronico deve herdar as properties da classe ProdutoFisico'
...
def test_cria_produtoEletronico_inicializado_corretamente(nome, preco, peso, tensao, tempo_garantia):
    try:
        prod = loja.ProdutoEletronico(
            nome, preco, peso, tensao, tempo_garantia)
    except Exception:
        raise AssertionError('Erro no construtor da classe ProdutoEletronico')
    assert hasattr(
        prod, "_Produto__nome"), "A classe Produto não possui o atributo privado nome"
    ...
    assert hasattr(
        prod, "_ProdutoFisico__peso"), "A classe ProdutoFisico não possui o atributo privado peso"
    assert hasattr(
        prod, "_ProdutoEletronico__tensao"), "A classe ProdutoEletronico não possui o atributo privado tensao"
    assert hasattr(
        prod, "_ProdutoEletronico__tempo_garantia"), "A classe ProdutoEletronico não possui o atributo privado tempo_garantia"
...
def test_produtoEletronico_property_tempo_garantia(meses):
    try:
        ...
        raise AssertionError(
            'Erro no valor da property tempo_garantia na classe ProdutoEletronico')
...
def test_produtoEletronico_property_tensao(tensao):
    try:
        ...
        raise AssertionError(
            'Erro no valor da property tensao na classe ProdutoEletronico')
...
def test_cria_produtoEletronico_tensao_tipo_invalido(tensao):
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError para ProdutoEletronico criado com tensao que não é int')
    else:
        raise AssertionError(
            'ProdutoEletronico criado com tensao com tipo inválido')
...
def test_cria_produtoEletronico_tensao_valor_invalido(tensao):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para ProdutoEletronico criado com tensao com valor diferente de 0, 127 ou 220')
    else:
        raise AssertionError(
            'ProdutoEletronico criado com tensao com valor inválido')
...
def test_produtoEletronico_setter_tensao_tipo_invalido(tensao):
    try:
        valor_inicial = 127
        prod = loja.ProdutoEletronico(
            'Geladeira', 5000, 35000, valor_inicial, 12)
        prod.tensao = tensao
    except TypeError:
        pass
    except Exception:
        raise AssertionError(
            'Erro diferente de TypeError no setter da tensao quando nova_tensao não é int')
    assert hasattr(
        prod, "_ProdutoEletronico__tensao"), "A classe ProdutoEletronico não possui o atributo privado tensao"
...
def test_produtoEletronico_setter_tensao_valor_invalido(tensao):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError no setter da tensao quando a nova_tensao possui valor diferente de 0, 127 ou 220')
    assert hasattr(
        prod, "_ProdutoEletronico__tensao"), "A classe ProdutoEletronico não possui o atributo privado tensao"
...
def test_produtoEletronico_metodo_calcular_preco_com_frete(preco, peso, total):
    ...
    assert prod.calcular_preco_com_frete(
    ) == total, "O método calcular_preco_com_frete() não calculou o preço com frete do ProdutoEletronico corretamente"
...
def test_ebook_heranca():
    try:
        ...
        raise AssertionError('Erro no construtor da classe Ebook')
    assert isinstance(prod, loja.Produto) and isinstance(
        prod, loja.Ebook), 'A classe Ebook deve herdar da classe Produto'
...
def test_ebook_caracteristicas_herdadas():
    try:
        ...
        raise AssertionError('Erro no construtor da classe Ebook')
    assert ('_Produto__nome' in dict_attrs_obj) and ('_Produto__preco' in dict_attrs_obj) and ('_Ebook__nome' not in dict_attrs_obj) and (
        '_Ebook__preco' not in dict_attrs_obj), 'A classe Ebook não deve possuir os atributos privados nome e preco'
    assert ('nome' not in dict_attrs_classe) and (
        'preco' not in dict_attrs_classe), 'A classe Ebook deve herdar as properties da classe Produto'
...
def test_cria_ebook_inicializado_corretamente(nome, preco, autor, numero_paginas):
    ...
    assert hasattr(
        prod, "_Produto__preco"), "A classe Produto não possui o atributo privado preco"
    assert hasattr(
        prod, "_Ebook__autor"), "A classe Ebook não possui o atributo privado autor"
    assert hasattr(
        prod, "_Ebook__numero_paginas"), "A classe Ebook não possui o atributo privado numero_paginas"
...
def test_ebook_property_nome_exibicao(nome, autor):
    try:
        ...
        raise AssertionError(
            'Erro no valor da property nome_exibicao na classe Ebook')


@pytest.mark.parametrize('numero_paginas', [100, 564])
def test_ebook_property_numero_paginas(numero_paginas):
    try:
        prod = loja.Ebook('Aprenda Python', 30,
                          'Joao da Silva', numero_paginas)
        assert prod.numero_paginas == numero_paginas
    except Exception:
        raise AssertionError(
            'Erro no valor da property numero_paginas na classe Ebook')
...
def test_cria_ebook_numero_paginas_nao_positivo(numero_paginas):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para Ebook criado com numero_paginas negativo ou igual a zero')
    else:
        raise AssertionError(
            'Ebook criado com numero_paginas negativo ou igual a zero')
...
def test_ebook_setter_numero_paginas_nao_positivo(numero_paginas):
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError no setter do numero_paginas quando o valor não é positivo')
    assert hasattr(
        prod, "_Ebook__numero_paginas"), "A classe Ebook não possui o atributo privado numero_paginas"
